...
import be.cipal.poc.v1.addressbook.VoidRequestV11
import be.cipal.poc.v1.addressbook.AddressResponseV11
...
public class AddressBookEndpoint {
    ...
    @PayloadRoot(namespace = "http://www.cipal.be/poc/v1/addressbook", localPart = "AddressRequest-v1_0")
    @ResponsePayload
    ...
    @PayloadRoot(namespace = "http://www.cipal.be/poc/v1/addressbook", localPart = "ListAddressRequest-v1_0")
    @ResponsePayload
